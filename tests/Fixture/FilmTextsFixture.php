 ...
 * FilmTextsFixture
 */
class FilmTextsFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'film_id' => ['type' => 'integer', 'length' => 6, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            'title' => ['type' => 'fulltext', 'columns' => ['title', 'description'], 'length' => []],
        ],
        '_constraints' => [
    ...
    public function init(): void
    {
        $this->records = [
            [
                'uuid' => 'c1dbee48-9efd-44de-b7d8-a875c9fb7e8a',
                'film_id' => 1,
